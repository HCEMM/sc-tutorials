...
Before you can make a reservation, you'll need an account.

<img src="../resources/EMMA/EMMA_register.png" alt="Registration" width="500">
...
<img src="../resources/EMMA/EMMA_registration_form.png" alt="Registration Form" width="500">
...
<img src="../resources/EMMA/EMMA_activation.png" alt="Activation Email" width="500">
...
Our system is built around a central booking calendar.

1.  Navigate to the **"Calendar"** page.
2.  **Select Your Microscope:** Use the filter to choose the microscope you wish to reserve.
3.  **View Availability:** The calendar will display all booked (gray) and available (white) time slots. Use the arrows to navigate between different days or weeks. Select the exact date to list available time slots.
4.  **Choose Your Slot:** Click on an **available** time slot.
5.  **Confirm Details:** The selected date and time slot appears.
    * Please verify the **date, time, and instrument**.
...
You can easily view all your upcoming reservations or cancel them if your plans change.
...
2.  Find the specific reservation you wish to cancel from the list.
3.  Click the **"Delete"** button next to the appointment.
4.  A prompt will ask you to confirm the cancellation. Click **"Yes"** to confirm.
...
## 🔭 Viewing Microscope Details

You can browse all available microscopes and their specifications before booking.

1.  Once logged in, navigate to the **"Microscopes"** page from the main menu.
2.  You will see a list of all available instruments.
3.  Click on any microscope's name (e.g., "Leica Stellaris") to view its details.
4.  Click on the **"Viev Details"** button to list important information, such as:
    * 📸 An image of the microscope
...
If you have any questions, encounter a problem with the website, or experience an issue with an instrument, please let us know.

1.  Navigate to the **"Contact"** page.
2.  Fill out the form with your name, email, and a detailed message describing your issue.
